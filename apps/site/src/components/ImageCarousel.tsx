...
export default function ImageCarousel({
  ...
  if (!images || images.length === 0) {
    return (
      <div
        className={`${height} flex items-center justify-center rounded-xl bg-gray-100 text-sm text-gray-400`}
      >
        {emptyText}
      </div>
    );
  ...
  return (
    <div
      className={`group relative ${height} overflow-hidden rounded-xl bg-gray-100`}
