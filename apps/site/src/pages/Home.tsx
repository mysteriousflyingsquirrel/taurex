const features = [
  {
    ...
    description:
      "Create beautiful public booking pages for your apartments. Guests book directly — no middleman needed.",
    icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1",
  },
  {
    title: "Calendar Management",
    description:
      "Keep track of all your bookings with an intuitive calendar view. Never double-book again.",
    icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
  },
  {
    title: "Custom Domains",
    description:
      "Use your own domain for booking pages. Your brand, your identity — fully white-labeled.",
    icon: "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9",
  },
  {
    title: "Secure & Simple",
    description:
      "Built on enterprise-grade infrastructure. Your data is safe and your setup is effortless.",
      ...
      <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28">
        ...
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600 sm:text-xl">
            Manage your apartments, accept bookings, and delight your guests —
            all from one simple platform. No complexity, no commissions.
          </p>
          <div className="mt-10 flex items-center justify-center gap-4">
            ...
            <a
              href="#features"
              className="rounded-lg px-6 py-3 text-base font-semibold text-gray-700 ring-1 ring-gray-300 hover:bg-gray-50"
            >
              Learn More
            </a>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              From booking pages to calendar management, Taurex gives you all the
              tools to run your rental business.
            </p>
          </div>
          ...
          <div className="mx-auto mt-16 grid max-w-5xl gap-8 lg:grid-cols-3">
            {pricingPlans.map((plan) => (
              ...
              >
                ...
                <p
                  className={`mt-1 text-sm ${plan.highlighted ? "text-indigo-100" : "text-gray-500"}`}
                >
                  {plan.description}
                </p>
                ...
                <ul className="mt-8 space-y-3">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-center gap-3 text-sm">
                      <svg
                        className={`h-5 w-5 flex-shrink-0 ${plan.highlighted ? "text-indigo-200" : "text-indigo-600"}`}
                        fill="none"
                        viewBox="0 0 24 24"
                        strokeWidth={2}
                        stroke="currentColor"
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-gray-600">
            Join property owners who trust Taurex to manage their vacation
            rentals. Get started in minutes.
          </p>
          <a
            href="https://app.taurex.one"
      ...
      <footer className="border-t border-gray-100 bg-gray-50 py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 sm:flex-row">
          ...
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Taurex. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
