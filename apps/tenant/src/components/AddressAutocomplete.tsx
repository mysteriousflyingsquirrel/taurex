...
/** Normalize a Nominatim result into a clean "Street Nr, ZIP City" format */
...
export default function AddressAutocomplete({
  ...
  const search = useCallback(async (q: string) => {
    ...
    try {
      ...
      // Filter to only results that have at least a road or city
      const filtered = data.filter(
        (r) => r.address && (r.address.road || r.address.city || r.address.town || r.address.village)
      );
