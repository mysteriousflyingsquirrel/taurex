...
export default function TenantManageLayout() {
  ...
  const confirmPhrase = `edit tenant ${tenant.slug}`;
        ...
        <div className="mx-auto mt-8 max-w-lg">
          <div className="rounded-xl border-2 border-amber-200 bg-amber-50 p-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              You are about to edit this tenant's configuration. To confirm,
              type:
            </p>
  ...
  return (
    <ManagedTenantProvider tenant={tenant} apartments={apartments} readonly={false}>
      {/* Amber safety banner */}
